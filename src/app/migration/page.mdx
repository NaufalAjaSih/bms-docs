...
Migration digunakan untuk membuat struktur database secara konsisten di dalam tim. Pada bagian ini, kita menetapkan standar tipe data serta kapan harus menggunakannya.
