...
- Memudahkan testing (service bisa di-_unit test_)
...
Service dapat di-_inject_ ke Controller melalui constructor.
...
Berikut contoh standar implementasi Service yang rapi dan sesuai standar:
...
Arsitektur ini mewajibkan setiap developer memindahkan logika berat dari Controller ke Service agar:
