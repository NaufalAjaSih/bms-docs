...
@section('content')
                        ...
                        <div className="card">
                            <div className="card-header p-3">
                                <div className="d-flex align-content-center justify-content-between">
                                    <h3 className="font-weight-bold text-lg">Product Management</h3>
                            ...
                            <div className="card-body">
                                <table className="table table-bordered table-striped data-table w-100">
                                    <thead>
                                        <tr>
                                            <th width="50px">No</th>
                                            <th>Image</th>
    ...
    <div className="modal fade" id="modalForm" tabIndex={-1} role="dialog" data-focus="false" aria-labelledby="modalFormLabel"
        aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div className="modal-dialog modal-dialog-centered modal-md" role="document">
            <div className="modal-content">
                <div className="modal-header bg-primary">
                    <h5 className="modal-title text-white font-weight-bold" id="modalFormLabel"></h5>
                ...
                <form id="formData" encType="multipart/form-data">
                    ...
                    <div className="modal-body">
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-sm-8">
                                <input type="number" name="price" id="price" className="form-control" min={0} />
                            </div>
                        </div>
                        <div className="form-group row">
                            <label className="col-sm-4 col-form-label">Stock*</label>
                            <div className="col-sm-8">
                                <input type="number" name="stock" id="stock" className="form-control" min={0} />
                            </div>
                        </div>
                        <div className="form-group row">
                            ...
                            <div className="col-sm-8">
                                <div className="image-preview-container"
                                    ...
                                    <div className="no-image-placeholder"
                                        ...
                                        <i className="fas fa-image" style={{fontSize: '24px', color: '#6c757d'}}></i>
                                    </div>
                                    <img id="image-preview" src="" alt="Preview"
                                        style={{width: '100%', height: '100%', objectFit: 'cover', display: 'none'}} />
                                    <button type="button" id="remove-image-btn" className="btn btn-danger btn-xs"
                        ...
                        <div className="form-group row">
                            ...
                            <div className="col-sm-8">
                                <select name="is_active" id="is_active" className="form-control select-status">
                                    <option value=""></option>
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="submit" className="btn btn-primary ms-1" id="submitBtn">
                            <span className="spinner-border spinner-border-sm mx-1 d-none" role="status"
    ...
    <script>
                ...
                error: function(response) {
                    if (response.status === 422) {
                        ...
                        $.each(errors, function(key, val) {
                            ...
                            input.parent().append(
                                '<span className="invalid-feedback" role="alert"><strong>' +
                                val[0] + '</strong></span>'
                            );
                        });
        ...
        $(document).on('click', '.delete-button', function(e) {
            ...
            Swal.fire({
                ...
                confirmButtonText: '<span className="swal-btn-text">Yes, Delete</span>',
                ...
                preConfirm: () => {
                    return new Promise((resolve) => {
                        ...
                        btnText.innerHTML =
                            `<span className="spinner-border spinner-border-sm mx-2" role="status" aria-hidden="true"></span> Deleting...`;
